...
const agentDirEnvName = "NPI_CODING_AGENT_DIR";
const startupBenchmarkEnvName = "NPI_STARTUP_BENCHMARK";
...
Options:
  ...
  --agent-dir <dir>      Use a specific NPI_CODING_AGENT_DIR for the benchmark run
  --isolated-agent-dir   Use a fresh temporary agent dir instead of the normal one
  --no-offline           Do not force NPI_OFFLINE=1 / NPI_SKIP_VERSION_CHECK=1
