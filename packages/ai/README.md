...
```bash
npm install @gerred/npi-ai
```

TypeBox exports are re-exported from `@gerred/npi-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@gerred/npi-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@gerred/npi-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@gerred/npi-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@gerred/npi-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@gerred/npi-ai';
...
```typescript
import { getModel, stream } from '@gerred/npi-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@gerred/npi-ai';
...
```typescript
import { Model, stream } from '@gerred/npi-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@gerred/npi-ai';
...
```typescript
import { getModel, complete, Context } from '@gerred/npi-ai';
...
```typescript
import { Context, getModel, complete } from '@gerred/npi-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@gerred/npi-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@gerred/npi-ai';
...
```bash
npx @gerred/npi-ai login              # interactive provider selection
npx @gerred/npi-ai login anthropic    # login to specific provider
npx @gerred/npi-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@gerred/npi-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@gerred/npi-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@gerred/npi-ai/oauth';
...
```typescript
import { getModel, complete } from '@gerred/npi-ai';
import { getOAuthApiKey } from '@gerred/npi-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@gerred/npi-ai`
