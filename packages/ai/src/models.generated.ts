...
export const MODELS = {
	...
	"noumena": {
		"kimi-2.7-coder": {
			...
			headers: {"x-app":"cli","anthropic-beta":"oauth-2025-04-20"},
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsReasoningEffort":true,"maxTokensField":"max_tokens","thinkingFormat":"noumena","supportsStrictMode":false,"supportsLongCacheRetention":false},
			reasoning: true,
			thinkingLevelMap: {"off":"none","minimal":null,"low":"medium","medium":"medium","high":"high","xhigh":null},
			input: ["text"],
			cost: {
				input: 0,
				output: 0,
