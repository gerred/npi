...
import { Agent, type AgentEvent, type AgentTool } from "@gerred/npi-agent-core";
import { type AssistantMessage, type AssistantMessageEvent, EventStream, getModel } from "@gerred/npi-ai";
