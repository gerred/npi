...
import type { AssistantMessage, Model } from "@gerred/npi-ai";
...
vi.mock("@gerred/npi-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@gerred/npi-ai")>();
	return {
		...actual,
