...
import { Agent } from "@gerred/npi-agent-core";
import { getModel, type OAuthCredentials, type OAuthProvider } from "@gerred/npi-ai";
 ...
 */
export const API_KEY = process.env.NOUMENA_API_KEY;

// ============================================================================
// OAuth API key resolution from ~/.npi/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".npi", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.npi/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.npi/agent/auth.json
 */
...
/** Path to the real npi agent config directory */
export const NPI_AGENT_DIR = join(homedir(), ".npi", "agent");

/**
 * Get an AuthStorage instance backed by ~/.npi/agent/auth.json
