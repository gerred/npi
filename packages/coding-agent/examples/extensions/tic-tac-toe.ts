...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@gerred/npi-coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@gerred/npi-tui";
