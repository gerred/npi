...
import type { BashToolDetails, EditToolDetails, ExtensionAPI, ReadToolDetails } from "@gerred/npi-coding-agent";
import { createBashTool, createEditTool, createReadTool, createWriteTool } from "@gerred/npi-coding-agent";
