...
import { complete, type Message } from "@gerred/npi-ai";
import type { ExtensionAPI, SessionEntry } from "@gerred/npi-coding-agent";
import { BorderedLoader, convertToLlm, serializeConversation } from "@gerred/npi-coding-agent";
