...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@gerred/npi-coding-agent";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@gerred/npi-tui";
import { Input, matchesKey, truncateToWidth, visibleWidth } from "@gerred/npi-tui";
