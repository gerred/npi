...
const MIGRATION_GUIDE_URL =
	"https://github.com/gerred/npi/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL = "https://github.com/gerred/npi/blob/main/packages/coding-agent/docs/extensions.md";
 ...
 *
 * Historical pi migration retained for users carrying forward old session files.
 */
