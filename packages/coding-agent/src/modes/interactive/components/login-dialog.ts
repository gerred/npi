import { getOAuthProviders, type OAuthDeviceCodeInfo } from "@gerred/npi-ai/oauth";
import { Container, type Focusable, getKeybindings, Input, Spacer, Text, type TUI } from "@gerred/npi-tui";
