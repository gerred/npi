...
import type { Agent, AgentEvent, AgentMessage, AgentState, AgentTool, ThinkingLevel } from "@gerred/npi-agent-core";
import type { AssistantMessage, ImageContent, Message, Model, TextContent } from "@gerred/npi-ai";
import {
	clampThinkingLevel,
