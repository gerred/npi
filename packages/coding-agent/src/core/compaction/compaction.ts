...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@gerred/npi-agent-core";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@gerred/npi-ai";
import { completeSimple } from "@gerred/npi-ai";
import {
	convertToLlm,
