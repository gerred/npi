import { ProcessTerminal, setKeybindings, TUI } from "@gerred/npi-tui";
...
const OFFICIAL_PACKAGE_NAME = "@gerred/npi-coding-agent";
const OFFICIAL_APP_NAME = "npi";
const OFFICIAL_CONFIG_DIR_NAME = ".npi";
 ...
 * - this is the official npi distribution
 * - experimental features are enabled (NPI_EXPERIMENTAL=1)
