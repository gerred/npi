...
For TypeScript definitions in your project, inspect `node_modules/@gerred/npi-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@gerred/npi-coding-agent";
