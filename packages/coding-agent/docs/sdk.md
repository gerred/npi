...
```typescript
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "@gerred/npi-coding-agent";
...
```bash
npm install @gerred/npi-coding-agent
```
...
```typescript
import { createAgentSession, SessionManager } from "@gerred/npi-coding-agent";
...
The `Agent` class (from `@gerred/npi-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { AuthStorage, ModelRegistry } from "@gerred/npi-coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@gerred/npi-coding-agent";
...
```typescript
import { createAgentSession } from "@gerred/npi-coding-agent";
...
import { createAgentSession, defineTool } from "@gerred/npi-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@gerred/npi-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@gerred/npi-coding-agent";
