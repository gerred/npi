...
```bash
npm uninstall -g @gerred/npi-coding-agent
```

For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @gerred/npi-coding-agent`, `yarn global remove @gerred/npi-coding-agent`, or `bun uninstall -g @gerred/npi-coding-agent`.
